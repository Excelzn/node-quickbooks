...
var Quickbooks = /** @class */ (function () {
    ...
    Quickbooks.prototype.reconnect = function () {
        var _a;
        return this.xmlRequest((_a = Quickbooks.RECONNECT_URL) !== null && _a !== void 0 ? _a : '', 'ReconnectResponse');
    };
    Quickbooks.prototype.disconnect = function () {
        var _a;
        return this.xmlRequest((_a = Quickbooks.DISCONNECT_URL) !== null && _a !== void 0 ? _a : '', 'PlatformResponse');
    };
    //CRUD endpoints
    //Invoice
